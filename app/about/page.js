...
export const metadata = {
  title: 'About Us — BPSV',
  description: 'Learn about Beyond Purpose Social Ventures — our mission, vision, team, and work in sustainable rural development.',
}
        ...
        <div className="about-cta">
          <div className="container">
            ...
            <div className="cta-btns">
              <Link href="/contact" className="cta-btn-primary"><i className="fa fa-paper-plane" style={{ marginRight: '8px' }}></i>Get in Touch</Link>
              <Link href="/projects" className="cta-btn-outline"><i className="fa fa-folder-open" style={{ marginRight: '8px' }}></i>View Our Projects</Link>
            </div>
          </div>
        </div>
