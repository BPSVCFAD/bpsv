...
export default function DoorstepServices() {
  ...
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: `.project-hero { background: linear-gradient(135deg, rgba(8,42,58,0.93) 0%, rgba(21,91,104,0.9) 55%, rgba(43,164,170,0.82) 100%), url("/assets/img/rural.png") center/cover no-repeat; }` }} />
