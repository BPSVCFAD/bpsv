          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-3 col-sm-6 footer-col">
                <h5>Our Projects</h5>
                <ul className="f-links">
                  <li><Link to="/projects/efficiency-for-access-enabling-dre-agribusiness">Efficiency for Access</Link></li>
                  <li><Link to="/projects/using-PURE-appliances-in-the-Livelihoods-Enterprises">CLASP MAF – Scaling DRE</Link></li>
                  <li><Link to="/projects/doorstep-business-services">DRIVE – Doorstep Services</Link></li>
