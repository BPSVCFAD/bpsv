...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const $immortalCarousel = $('.animate_text')
    const $firstAnimatingElems = $immortalCarousel.find('.item:first').find("[data-animation ^= 'animated']")
    ...
    return () => {
      $immortalCarousel.off('slide.bs.carousel.home')
      if ($.fn.owlCarousel) {
            ...
            <div className="row">
              <div className="col-md-12">
                <div className="services-carousel-4-col owl-carousel owl-theme">
                  <div className="item">
                    <div className="icon">
                      <i className="flaticon-architect"></i>
                    </div>
          ...
          <div className="portfolio-items text-light magnific-mix-gallery masonary portfolio-carousel-3-col owl-carousel owl-theme">
            <div className="pf-item">
              <div className="item-effect">
                ...
                <div className="icons">
                  <h4><Link to="/projects/efficiency-for-access-enabling-dre-agribusiness">Empowering Rural Entrepreneurs</Link></h4>
                  <div className="cat">
                    <Link to="/projects/efficiency-for-access-enabling-dre-agribusiness">Meghalaya (Apr 2024 - Dec 2025) — CLASP</Link>
                  </div>
              ...
              <div className="testimonial-items testimonial-carousel owl-carousel owl-theme">
                <div className="item">
                  ...
                  <div className="col-md-7 info">
                    ...
                    <Link to="/projects/using-PURE-appliances-in-the-Livelihoods-Enterprises" style={{ display: 'inline-block', marginTop: '10px', color: '#fff', fontWeight: '600', fontSize: '13px', textDecoration: 'none', letterSpacing: '0.03em' }}>
                ...
                <div className="item">
                  ...
                  <div className="col-md-7 info">
                    ...
                    <Link to="/projects" style={{ display: 'inline-block', marginTop: '10px', color: '#fff', fontWeight: '600', fontSize: '13px', textDecoration: 'none', letterSpacing: '0.03em' }}>
                      Learn More <i className="fa fa-arrow-right" style={{ fontSize: '11px', color: '#fff' }}></i>
                    </Link>
                  </div>
                </div>
                <div className="item">
                  ...
                  <div className="col-md-7 info">
                    ...
                    <Link to="/projects/doorstep-business-services" style={{ display: 'inline-block', marginTop: '10px', color: '#fff', fontWeight: '600', fontSize: '13px', textDecoration: 'none', letterSpacing: '0.03em' }}>
                      Learn More <i className="fa fa-arrow-right" style={{ fontSize: '11px', color: '#fff' }}></i>
                    </Link>
                  </div>
                </div>
