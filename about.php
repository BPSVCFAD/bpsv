...
$pageTitle   = 'About Us — BPSV | Beyond Purpose Social Ventures';
$metaDesc    = 'Learn about Beyond Purpose Social Ventures — our mission, team, and approach to sustainable rural development through DRE, incubation, and ecosystem building.';
$currentPage = 'about';
$pageStyles  = '
   /* ── Hero ── */
   .about-hero {
...
?>
   ...
   <div class="about-page">
      ...
      <div class="about-section-pad bg-light-teal">
         <div class="container">
            <div class="text-center" style="max-width:640px; margin:0 auto;">
               <div class="ab-label" style="justify-content:center;">
                  <span class="line"></span><span class="text">Who We Are</span><span class="line"></span>
               </div>
               <h2 class="ab-heading">Beyond Purpose <strong>Social Ventures</strong></h2>
               <p class="ab-sub">
            ...
            <div class="mvv-grid">
               ...
               <div class="mvv-card">
                  <div class="mvv-icon"><i class="fa fa-heart"></i></div>
                  <h3>Our Values</h3>
                  <p>
      ...
      <div class="about-section-pad">
         <div class="container">
            <div class="row">
               <div class="col-md-5">
                  <div class="story-img">
                     <img src="/bpsv/assets/img/Dhar Atta.JPG" alt="BPSV team working with rural entrepreneurs">
                  </div>
               </div>
               <div class="col-md-7">
                  <div class="story-text">
                     <div class="ab-label"><span class="line"></span><span class="text">Our Story</span></div>
                     <h2 class="ab-heading">Rooted in the <strong>Field</strong></h2>
                     <p>
                     ...
                     <div class="focus-chips">
                        <span class="focus-chip"><i class="fa fa-bolt"></i> Distributed Renewable Energy</span>
                        <span class="focus-chip"><i class="fa fa-home"></i> Doorstep Incubation</span>
                        <span class="focus-chip"><i class="fa fa-users"></i> Women Empowerment</span>
                        <span class="focus-chip"><i class="fa fa-leaf"></i> Rural Agribusiness</span>
                        <span class="focus-chip"><i class="fa fa-cloud"></i> Climate Adaptation</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <!-- ── Stats ── -->
      <div class="about-section-pad bg-dark-navy" style="padding: 0;">
         <div class="stats-bar">
            ...
            <div class="stat-block">
               <div class="num">5</div>
               <div class="lbl">States of Operation</div>
            </div>
            <div class="stat-block">
               <div class="num">25+</div>
               <div class="lbl">Enterprises Supported</div>
            </div>
            <div class="stat-block">
               <div class="num">100+</div>
               <div class="lbl">Entrepreneurs Impacted</div>
            </div>
         </div>
      </div>

      <!-- ── Geographies ── -->
      <div class="about-section-pad bg-dark-navy">
         <div class="container">
            <div class="text-center" style="max-width:600px; margin:0 auto;">
               <div class="ab-label" style="justify-content:center;">
                  <span class="line"></span><span class="text">Where We Work</span><span class="line"></span>
               </div>
               <h2 class="ab-heading">Our <strong>Geographies</strong></h2>
               <p class="ab-sub">
            ...
            <div class="geo-grid">
               <div class="geo-card">
                  ...
                  <div class="geo-name">Assam</div>
                  <div class="geo-desc">DRE ecosystem building &amp; livelihood enterprises</div>
               </div>
               <div class="geo-card">
                  <i class="fa fa-map-marker"></i>
                  <div class="geo-name">Nagaland</div>
                  <div class="geo-desc">PURE appliances in agri-processing value chains</div>
               </div>
               <div class="geo-card">
                  <i class="fa fa-map-marker"></i>
                  <div class="geo-name">Meghalaya</div>
                  <div class="geo-desc">Solar-powered agribusiness transformation</div>
               </div>
               <div class="geo-card">
                  <i class="fa fa-map-marker"></i>
                  <div class="geo-name">Karnataka</div>
                  <div class="geo-desc">Climate adaptation &amp; women foodpreneur incubation</div>
               </div>
               <div class="geo-card">
                  <i class="fa fa-map-marker"></i>
                  <div class="geo-name">Odisha</div>
                  <div class="geo-desc">Doorstep business services for women entrepreneurs</div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="about-section-pad">
         <div class="container">
            <div class="text-center" style="max-width:600px; margin:0 auto;">
               <div class="ab-label" style="justify-content:center;">
                  <span class="line"></span><span class="text">Our People</span><span class="line"></span>
               </div>
               <h2 class="ab-heading">Meet the <strong>Team</strong></h2>
               <p class="ab-sub">
            ...
            <div class="team-grid">
               ...
               <div class="team-card">
                  <div class="tc-photo">
                     <img src="/bpsv/assets/img/kartik.png" alt="Nagakarthik MP">
                  </div>
                  <div class="tc-info">
                     ...
                     <div class="tc-social">
                        <a href="https://www.linkedin.com/in/nagakarthik-mp-03010938/" target="_blank" rel="noopener"><i class="fab fa-linkedin"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="team-card">
                  <div class="tc-photo">
                     <img src="/bpsv/assets/img/neil.png" alt="Neil Murlidhar Kamat">
                  </div>
                  <div class="tc-info">
                     ...
                     <div class="tc-social">
                        <a href="https://www.linkedin.com/in/neilkamat/" target="_blank" rel="noopener"><i class="fab fa-linkedin"></i></a>
                     </div>
                  </div>
               </div>
               ...
               <div class="team-card">
                  <div class="tc-photo">
                     <img src="/bpsv/assets/img/gunajit.png" alt="Gunajit Dev Sarma">
                  </div>
                  <div class="tc-info">
               ...
               <div class="team-card">
                  <div class="tc-photo">
                     <img src="/bpsv/assets/img/atanu.png" alt="Atanu Garai">
                  </div>
                  <div class="tc-info">
                     <h4>Atanu Garai</h4>
                     <div class="role">Lead – Knowledge Management</div>
               ...
               <div class="team-card">
                  <div class="tc-photo">
                     <img src="/bpsv/assets/img/himadri.png" alt="Himadri Gogoi">
                  </div>
                  <div class="tc-info">
                     <h4>Himadri Gogoi</h4>
                     <div class="role">Manager – Grant Writing</div>
               ...
               <div class="team-card">
                  <div class="tc-photo">
                     <img src="/bpsv/assets/img/rohan.png" alt="Rohan Bose">
                  </div>
                  <div class="tc-info">
                     <h4>Rohan Bose</h4>
                     <div class="role">Software Analyst</div>
                     <p>Supports digital innovation and technology solutions for social impact projects.</p>
                     <div class="tc-social">
                        <a href="https://www.linkedin.com/in/rohanbose-rb/" target="_blank" rel="noopener"><i class="fab fa-linkedin"></i></a>
                     </div>
                  </div>
               </div>
      ...
      <div class="about-cta">
         <div class="container">
            ...
            <div class="cta-btns">
               <a href="/bpsv/contact.php" class="cta-btn-primary"><i class="fa fa-paper-plane" style="margin-right:8px;"></i>Get in Touch</a>
               <a href="/bpsv/projects/" class="cta-btn-outline"><i class="fa fa-folder-open" style="margin-right:8px;"></i>View Our Projects</a>
            </div>
         </div>
      </div>
